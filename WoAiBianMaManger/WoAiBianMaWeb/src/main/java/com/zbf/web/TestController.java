...
import com.zbf.zhongjian.test.WebSocketServerTest;
...
public class TestController {
   ...
   @Autowired
    ...
    public void sendTest(){
        Session session = WebSocketServerTest.sessionMap.get("1");
        WebSocketServerTest.sendMessage(session,"hi 我是后端Server","1");
